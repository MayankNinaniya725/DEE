...
from . import views
from .views.core import process_pdf, dashboard, upload_pdf
...
from .views.single_file_package import download_single_file_package


urlpatterns = [
    # Redirect root to dashboard (not admin)
